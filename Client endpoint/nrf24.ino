...
void loop() {
  ...
  if (role) {
    ...
    bool report = radio.write(&payload, sizeof(double));  // transmit & save the report
    ...
    if (radio.available(&pipe)) {              // is there a payload? get the pipe number that recieved it
      ...
      Serial.print(payload[2]); Serial.print(" ");
      Serial.print(payload[3]); Serial.print("\n");
